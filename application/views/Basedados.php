...
<div class="container geral">
	...
	<div class="row">
		...
		<div class="col-1"></div>
		<div class="col-1">
			<a href="http://radarparlamentar.polignu.org/" class="btn btn-primary " style="color: #ffffff; background-color: #790505; border-color: #790505">Radar parlamentar</a>
		</div>
	</div>
              ...
              <h5 class="mb-0">
                ...
                <div id="<?php echo $dado->id; ?>" class="collapse" aria-labelledby="<?php echo $dado->id; ?>" data-parent="#accordion">
                      <div class="card-body">   
                          ...
                          <h5>Conteúdo </h5>
                          <p class="lead"> <?php echo $dado->conteudo; ?></p>
